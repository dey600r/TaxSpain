...
COLUMNA 4 -> `IMPUESTOS`
FILAS FIJAS - Se calculan automaticamente porque no son editables
1 - Calculo automático: ((TABLA BASE COTIZACION COLUMNA 3 BASE IRPF - COLUMNA 2 INICIO FILA 1) - (TOTAL BASE COTIZACION COLUMNA 3 TOTAL - COLUMNA 2 INICIO FILA 2)) * COLUMNA 3 % FILA 1
2 - Calculo automático: ((TABLA BASE COTIZACION COLUMNA 3 BASE IRPF - COLUMNA 2 INICIO FILA 2) - (TOTAL BASE COTIZACION COLUMNA 3 TOTAL - COLUMNA 2 INICIO FILA 3)) * COLUMNA 3 % FILA 2
3 - Calculo automático: ((TABLA BASE COTIZACION COLUMNA 3 BASE IRPF - COLUMNA 2 INICIO FILA 3) - (TOTAL BASE COTIZACION COLUMNA 3 TOTAL - COLUMNA 2 INICIO FILA 4)) * COLUMNA 3 % FILA 3
4 - Calculo automático: ((TABLA BASE COTIZACION COLUMNA 3 BASE IRPF - COLUMNA 2 INICIO FILA 4) - (TOTAL BASE COTIZACION COLUMNA 3 TOTAL - COLUMNA 2 INICIO FILA 5)) * COLUMNA 3 % FILA 4
5 - Calculo automático: ((TABLA BASE COTIZACION COLUMNA 3 BASE IRPF - COLUMNA 2 INICIO FILA 5) - (TOTAL BASE COTIZACION COLUMNA 3 TOTAL - COLUMNA 2 INICIO FILA 6)) * COLUMNA 3 % FILA 5
6 - Calculo automático: ((TABLA BASE COTIZACION COLUMNA 3 BASE IRPF - COLUMNA 2 INICIO FILA 6) - (TOTAL BASE COTIZACION COLUMNA 3 TOTAL - COLUMNA 2 INICIO FILA 7)) * COLUMNA 3 % FILA 6
